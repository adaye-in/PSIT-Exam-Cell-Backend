"""
Django settings for PSITExamCellBackend project.
...
SECRET_KEY = 'django-insecure-3^4+n#dd)hsbgqew(camel@d^1+mn1ss)i^9s&7$it9w+m)t^8'
...
ROOT_URLCONF = 'PSITExamCellBackend.urls'
